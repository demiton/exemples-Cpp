...
QT_MOC_LITERAL(1, 7, 12), // "pointChanged"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 10), // "updateRomb"
QT_MOC_LITERAL(4, 32, 10), // "startPoint"
QT_MOC_LITERAL(5, 43, 8) // "endPoint"

    },
    "Figure\0pointChanged\0\0updateRomb\0"
    "startPoint\0endPoint"
};
...
static const uint qt_meta_data_Figure[] = {
 ...
 // properties: name, type, flags
       ...
       5, QMetaType::QPointF, 0x00495103,
...
void Figure::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Figure::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Figure::pointChanged)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Figure::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Figure.data,
      qt_meta_data_Figure,  qt_static_metacall, nullptr, nullptr}
};
...
void *Figure::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsItem"))
        return static_cast< QGraphicsItem*>(const_cast< Figure*>(this));
